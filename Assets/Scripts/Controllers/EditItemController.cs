...
public class EditItemController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toggleEvent.onValueChanged.AddListener(_ => UpdateReminderVisibility());
        toggleReminder.onValueChanged.AddListener(_ => UpdateReminderVisibility());
    ...
    {
        reminderRow.SetActive(toggleReminder.isOn);
    }
    ...
    void LoadContext()
    {
        ...
        else
        {
            ...
            _item = new CalendarItem
            {
                ...
                StartUtc = (EditItemContext.SelectedDate ?? DateTime.Today).ToUniversalTime(),
    ...
    void BuildUIFromItem()
    {
        ...
        // TODO: Use both start and end
        dateInput.text = _item.StartUtc.ToString("yyyy-MM-dd");
        timeInput.text = _item.StartUtc.ToString("HH:mm");
        // TODO: the rest
